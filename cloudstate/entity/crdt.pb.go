...
type CrdtStateAction struct {
	...
	WriteConsistency CrdtWriteConsistency     `protobuf:"varint,3,opt,name=write_consistency,json=writeConsistency,proto3,enum=cloudstate.crdt.CrdtWriteConsistency" json:"write_consistency,omitempty"`
}
...
var file_crdt_proto_rawDesc = []byte{
	...
	0x42, 0x50, 0x0a, 0x16, 0x69, 0x6f, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x73, 0x74, 0x61, 0x74,
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x5a, 0x36, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x65, 0x69, 0x67, 0x72, 0x2f, 0x70, 0x65, 0x72, 0x6d,
	0x61, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2d, 0x67, 0x6f, 0x2f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x73,
	0x74, 0x61, 0x74, 0x65, 0x2f, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x3b, 0x65, 0x6e, 0x74, 0x69,
...
var file_crdt_proto_goTypes = []interface{}{
	...
	(*CrdtDelta)(nil),                   // 4: cloudstate.crdt.CrdtDelta
	(*GCounterDelta)(nil),               // 5: cloudstate.crdt.GCounterDelta
	(*PNCounterDelta)(nil),              // 6: cloudstate.crdt.PNCounterDelta
	(*GSetDelta)(nil),                   // 7: cloudstate.crdt.GSetDelta
	(*ORSetDelta)(nil),                  // 8: cloudstate.crdt.ORSetDelta
	(*LWWRegisterDelta)(nil),            // 9: cloudstate.crdt.LWWRegisterDelta
	(*FlagDelta)(nil),                   // 10: cloudstate.crdt.FlagDelta
	(*ORMapDelta)(nil),                  // 11: cloudstate.crdt.ORMapDelta
	(*ORMapEntryDelta)(nil),             // 12: cloudstate.crdt.ORMapEntryDelta
	(*VoteDelta)(nil),                   // 13: cloudstate.crdt.VoteDelta
	(*CrdtInit)(nil),                    // 14: cloudstate.crdt.CrdtInit
	(*CrdtDelete)(nil),                  // 15: cloudstate.crdt.CrdtDelete
	(*CrdtReply)(nil),                   // 16: cloudstate.crdt.CrdtReply
	(*CrdtStateAction)(nil),             // 17: cloudstate.crdt.CrdtStateAction
	(*CrdtStreamedMessage)(nil),         // 18: cloudstate.crdt.CrdtStreamedMessage
	(*CrdtStreamCancelledResponse)(nil), // 19: cloudstate.crdt.CrdtStreamCancelledResponse
	(*protocol.Command)(nil),            // 20: cloudstate.Command
	(*protocol.StreamCancelled)(nil),    // 21: cloudstate.StreamCancelled
	(*protocol.Failure)(nil),            // 22: cloudstate.Failure
	(*any.Any)(nil),                     // 23: google.protobuf.Any
	(*protocol.ClientAction)(nil),       // 24: cloudstate.ClientAction
	(*protocol.SideEffect)(nil),         // 25: cloudstate.SideEffect
}
var file_crdt_proto_depIdxs = []int32{
	14, // 0: cloudstate.crdt.CrdtStreamIn.init:type_name -> cloudstate.crdt.CrdtInit
	4,  // 1: cloudstate.crdt.CrdtStreamIn.delta:type_name -> cloudstate.crdt.CrdtDelta
	15, // 2: cloudstate.crdt.CrdtStreamIn.delete:type_name -> cloudstate.crdt.CrdtDelete
	20, // 3: cloudstate.crdt.CrdtStreamIn.command:type_name -> cloudstate.Command
	21, // 4: cloudstate.crdt.CrdtStreamIn.stream_cancelled:type_name -> cloudstate.StreamCancelled
	16, // 5: cloudstate.crdt.CrdtStreamOut.reply:type_name -> cloudstate.crdt.CrdtReply
	18, // 6: cloudstate.crdt.CrdtStreamOut.streamed_message:type_name -> cloudstate.crdt.CrdtStreamedMessage
	19, // 7: cloudstate.crdt.CrdtStreamOut.stream_cancelled_response:type_name -> cloudstate.crdt.CrdtStreamCancelledResponse
	22, // 8: cloudstate.crdt.CrdtStreamOut.failure:type_name -> cloudstate.Failure
	5,  // 9: cloudstate.crdt.CrdtDelta.gcounter:type_name -> cloudstate.crdt.GCounterDelta
	6,  // 10: cloudstate.crdt.CrdtDelta.pncounter:type_name -> cloudstate.crdt.PNCounterDelta
	7,  // 11: cloudstate.crdt.CrdtDelta.gset:type_name -> cloudstate.crdt.GSetDelta
	8,  // 12: cloudstate.crdt.CrdtDelta.orset:type_name -> cloudstate.crdt.ORSetDelta
	9,  // 13: cloudstate.crdt.CrdtDelta.lwwregister:type_name -> cloudstate.crdt.LWWRegisterDelta
	10, // 14: cloudstate.crdt.CrdtDelta.flag:type_name -> cloudstate.crdt.FlagDelta
	11, // 15: cloudstate.crdt.CrdtDelta.ormap:type_name -> cloudstate.crdt.ORMapDelta
	13, // 16: cloudstate.crdt.CrdtDelta.vote:type_name -> cloudstate.crdt.VoteDelta
	23, // 17: cloudstate.crdt.GSetDelta.added:type_name -> google.protobuf.Any
	23, // 18: cloudstate.crdt.ORSetDelta.removed:type_name -> google.protobuf.Any
	23, // 19: cloudstate.crdt.ORSetDelta.added:type_name -> google.protobuf.Any
	23, // 20: cloudstate.crdt.LWWRegisterDelta.value:type_name -> google.protobuf.Any
	1,  // 21: cloudstate.crdt.LWWRegisterDelta.clock:type_name -> cloudstate.crdt.CrdtClock
	23, // 22: cloudstate.crdt.ORMapDelta.removed:type_name -> google.protobuf.Any
	12, // 23: cloudstate.crdt.ORMapDelta.updated:type_name -> cloudstate.crdt.ORMapEntryDelta
	12, // 24: cloudstate.crdt.ORMapDelta.added:type_name -> cloudstate.crdt.ORMapEntryDelta
	23, // 25: cloudstate.crdt.ORMapEntryDelta.key:type_name -> google.protobuf.Any
	4,  // 26: cloudstate.crdt.ORMapEntryDelta.delta:type_name -> cloudstate.crdt.CrdtDelta
	4,  // 27: cloudstate.crdt.CrdtInit.delta:type_name -> cloudstate.crdt.CrdtDelta
	24, // 28: cloudstate.crdt.CrdtReply.client_action:type_name -> cloudstate.ClientAction
	25, // 29: cloudstate.crdt.CrdtReply.side_effects:type_name -> cloudstate.SideEffect
	17, // 30: cloudstate.crdt.CrdtReply.state_action:type_name -> cloudstate.crdt.CrdtStateAction
	4,  // 31: cloudstate.crdt.CrdtStateAction.update:type_name -> cloudstate.crdt.CrdtDelta
	15, // 32: cloudstate.crdt.CrdtStateAction.delete:type_name -> cloudstate.crdt.CrdtDelete
	0,  // 33: cloudstate.crdt.CrdtStateAction.write_consistency:type_name -> cloudstate.crdt.CrdtWriteConsistency
	24, // 34: cloudstate.crdt.CrdtStreamedMessage.client_action:type_name -> cloudstate.ClientAction
	25, // 35: cloudstate.crdt.CrdtStreamedMessage.side_effects:type_name -> cloudstate.SideEffect
	25, // 36: cloudstate.crdt.CrdtStreamCancelledResponse.side_effects:type_name -> cloudstate.SideEffect
	17, // 37: cloudstate.crdt.CrdtStreamCancelledResponse.state_action:type_name -> cloudstate.crdt.CrdtStateAction
	2,  // 38: cloudstate.crdt.Crdt.handle:input_type -> cloudstate.crdt.CrdtStreamIn
	3,  // 39: cloudstate.crdt.Crdt.handle:output_type -> cloudstate.crdt.CrdtStreamOut
