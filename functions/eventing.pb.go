...
// 	protoc        v3.11.2
// source: functions/eventing.proto
...
var file_cloudstate_eventing_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Field:         1081,
		Name:          "functions.eventing",
		Tag:           "bytes,1081,opt,name=eventing",
		Filename:      "functions/eventing.proto",
	},
}

// Extension fields to descriptor.MethodOptions.
var (
	// optional functions.Eventing eventing = 1081;
...
var file_cloudstate_eventing_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x67, 0x42, 0x56, 0x0a, 0x0d, 0x69, 0x6f, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x73,
	...
	0x6f, 0x2d, 0x73, 0x64, 0x6b, 0x2f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x73, 0x74, 0x61, 0x74, 0x65,
	0x3b, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x73, 0x74, 0x61, 0x74, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_cloudstate_eventing_proto_goTypes = []interface{}{
	(*Eventing)(nil),                 // 0: functions.Eventing
	(*EventSource)(nil),              // 1: functions.EventSource
	(*EventDestination)(nil),         // 2: functions.EventDestination
	(*descriptor.MethodOptions)(nil), // 3: google.protobuf.MethodOptions
}
var file_cloudstate_eventing_proto_depIdxs = []int32{
	1, // 0: functions.Eventing.in:type_name -> functions.EventSource
	2, // 1: functions.Eventing.out:type_name -> functions.EventDestination
	3, // 2: functions.eventing:extendee -> google.protobuf.MethodOptions
	0, // 3: functions.eventing:type_name -> functions.Eventing
