...
// Eigr Functions CRDTs support handling server streamed calls, that is, when the
...
// however the Eigr Functions supplied support libraries only allow sending messages
