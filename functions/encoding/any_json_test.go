...
func TestMarshalling(t *testing.T) {
	t.Run("marshals to functions any.Any", func(t *testing.T) {
		s := &a{B: "29", C: 29}
		x, err := MarshalJSON(s)
		if err != nil {
			t.Fail()
		}
		url := "json.functions.io/github.com/eigr/functions-go-sdk/functions/encoding.a"
		if x.GetTypeUrl() != url {
			t.Fail()
		}
	})
...
var testsJSON = []struct {
	...
	{JSONTypeURLPrefix + "/github.com/cloudstateio/go-support/functions/encoding.a",
		&a{B: "29", C: 29}, &a{}, JSONTypeURLPrefix + "/github.com/cloudstateio/go-support/functions/encoding.a", false},
	{JSONTypeURLPrefix + "/github.com/cloudstateio/go-support/functions/encoding.a",
		a{B: "29", C: 29}, a{}, JSONTypeURLPrefix + "/github.com/cloudstateio/go-support/functions/encoding.a", false},
	{JSONTypeURLPrefix + "/github.com/cloudstateio/go-support/functions/encoding.aDefault" + "_defaultValue",
		aDefault{}, aDefault{}, JSONTypeURLPrefix + "/github.com/cloudstateio/go-support/functions/encoding.aDefault", false},
}
