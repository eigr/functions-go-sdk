...
const (
	JSONTypeURLPrefix = "json.functions.io"
)
...
// MarshalJSON encodes a struct type into its Eigr Functions Any JSON value.
...
// UnmarshalPrimitive decodes a Eigr Functions Any protobuf message into its JSON value.
