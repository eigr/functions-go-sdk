...
func (c *eventSourcedClient) Handle(ctx context.Context, opts ...grpc.CallOption) (EventSourced_HandleClient, error) {
	stream, err := c.cc.NewStream(ctx, &_EventSourced_serviceDesc.Streams[0], "/functions.eventsourced.EventSourced/handle", opts...)
	if err != nil {
		return nil, err
	}
...
var _EventSourced_serviceDesc = grpc.ServiceDesc{
	ServiceName: "functions.eventsourced.EventSourced",
