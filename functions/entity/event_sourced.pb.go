...
var file_event_sourced_proto_goTypes = []interface{}{
	(*EventSourcedInit)(nil),      // 0: functions.eventsourced.EventSourcedInit
	(*EventSourcedSnapshot)(nil),  // 1: functions.eventsourced.EventSourcedSnapshot
	(*EventSourcedEvent)(nil),     // 2: functions.eventsourced.EventSourcedEvent
	(*EventSourcedReply)(nil),     // 3: functions.eventsourced.EventSourcedReply
	(*EventSourcedStreamIn)(nil),  // 4: functions.eventsourced.EventSourcedStreamIn
	(*EventSourcedStreamOut)(nil), // 5: functions.eventsourced.EventSourcedStreamOut
	(*any.Any)(nil),               // 6: google.protobuf.Any
	(*protocol.ClientAction)(nil), // 7: functions.ClientAction
	(*protocol.SideEffect)(nil),   // 8: functions.SideEffect
	(*protocol.Command)(nil),      // 9: functions.Command
	(*protocol.Failure)(nil),      // 10: functions.Failure
}
var file_event_sourced_proto_depIdxs = []int32{
	1,  // 0: functions.eventsourced.EventSourcedInit.snapshot:type_name -> functions.eventsourced.EventSourcedSnapshot
	6,  // 1: functions.eventsourced.EventSourcedSnapshot.snapshot:type_name -> google.protobuf.Any
	6,  // 2: functions.eventsourced.EventSourcedEvent.payload:type_name -> google.protobuf.Any
	7,  // 3: functions.eventsourced.EventSourcedReply.client_action:type_name -> functions.ClientAction
	8,  // 4: functions.eventsourced.EventSourcedReply.side_effects:type_name -> functions.SideEffect
	6,  // 5: functions.eventsourced.EventSourcedReply.events:type_name -> google.protobuf.Any
	6,  // 6: functions.eventsourced.EventSourcedReply.snapshot:type_name -> google.protobuf.Any
	0,  // 7: functions.eventsourced.EventSourcedStreamIn.init:type_name -> functions.eventsourced.EventSourcedInit
	2,  // 8: functions.eventsourced.EventSourcedStreamIn.event:type_name -> functions.eventsourced.EventSourcedEvent
	9,  // 9: functions.eventsourced.EventSourcedStreamIn.command:type_name -> functions.Command
	3,  // 10: functions.eventsourced.EventSourcedStreamOut.reply:type_name -> functions.eventsourced.EventSourcedReply
	10, // 11: functions.eventsourced.EventSourcedStreamOut.failure:type_name -> functions.Failure
	4,  // 12: functions.eventsourced.EventSourced.handle:input_type -> functions.eventsourced.EventSourcedStreamIn
	5,  // 13: functions.eventsourced.EventSourced.handle:output_type -> functions.eventsourced.EventSourcedStreamOut
