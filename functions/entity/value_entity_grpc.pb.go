...
func (c *valueEntityClient) Handle(ctx context.Context, opts ...grpc.CallOption) (ValueEntity_HandleClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ValueEntity_serviceDesc.Streams[0], "/functions.valueentity.ValueEntity/handle", opts...)
	if err != nil {
		return nil, err
	}
...
var _ValueEntity_serviceDesc = grpc.ServiceDesc{
	ServiceName: "functions.valueentity.ValueEntity",
