...
type ServiceInfo struct {
	...
	// If using a support library, the name of that library, eg "functions"
...
type Entity struct {
	...
	// service name, for example, functions.eventsourced.EventSourced.
...
var file_entity_proto_rawDesc = []byte{
	...
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x42, 0x57, 0x0a, 0x16, 0x69, 0x6f, 0x2e, 0x63, 0x6c,
	0x6f, 0x75, 0x64, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f,
	0x6c, 0x5a, 0x3d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x65, 0x69,
	0x67, 0x72, 0x2f, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2d, 0x67, 0x6f, 0x2d,
	0x73, 0x64, 0x6b, 0x2f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2f, 0x70,
...
var file_entity_proto_goTypes = []interface{}{
	(*Metadata)(nil),                   // 0: functions.Metadata
	(*MetadataEntry)(nil),              // 1: functions.MetadataEntry
	(*Reply)(nil),                      // 2: functions.Reply
	(*Forward)(nil),                    // 3: functions.Forward
	(*ClientAction)(nil),               // 4: functions.ClientAction
	(*SideEffect)(nil),                 // 5: functions.SideEffect
	(*Command)(nil),                    // 6: functions.Command
	(*StreamCancelled)(nil),            // 7: functions.StreamCancelled
	(*Failure)(nil),                    // 8: functions.Failure
	(*EntitySpec)(nil),                 // 9: functions.EntitySpec
	(*ServiceInfo)(nil),                // 10: functions.ServiceInfo
	(*Entity)(nil),                     // 11: functions.Entity
	(*EntityPassivationStrategy)(nil),  // 12: functions.EntityPassivationStrategy
	(*TimeoutPassivationStrategy)(nil), // 13: functions.TimeoutPassivationStrategy
	(*UserFunctionError)(nil),          // 14: functions.UserFunctionError
	(*ProxyInfo)(nil),                  // 15: functions.ProxyInfo
	(*any.Any)(nil),                    // 16: google.protobuf.Any
	(*empty.Empty)(nil),                // 17: google.protobuf.Empty
}
var file_entity_proto_depIdxs = []int32{
	1,  // 0: functions.Metadata.entries:type_name -> functions.MetadataEntry
	16, // 1: functions.Reply.payload:type_name -> google.protobuf.Any
	0,  // 2: functions.Reply.metadata:type_name -> functions.Metadata
	16, // 3: functions.Forward.payload:type_name -> google.protobuf.Any
	0,  // 4: functions.Forward.metadata:type_name -> functions.Metadata
	2,  // 5: functions.ClientAction.reply:type_name -> functions.Reply
	3,  // 6: functions.ClientAction.forward:type_name -> functions.Forward
	8,  // 7: functions.ClientAction.failure:type_name -> functions.Failure
	16, // 8: functions.SideEffect.payload:type_name -> google.protobuf.Any
	0,  // 9: functions.SideEffect.metadata:type_name -> functions.Metadata
	16, // 10: functions.Command.payload:type_name -> google.protobuf.Any
	0,  // 11: functions.Command.metadata:type_name -> functions.Metadata
	11, // 12: functions.EntitySpec.entities:type_name -> functions.Entity
	10, // 13: functions.EntitySpec.service_info:type_name -> functions.ServiceInfo
	12, // 14: functions.Entity.passivation_strategy:type_name -> functions.EntityPassivationStrategy
	13, // 15: functions.EntityPassivationStrategy.timeout:type_name -> functions.TimeoutPassivationStrategy
	15, // 16: functions.EntityDiscovery.discover:input_type -> functions.ProxyInfo
	14, // 17: functions.EntityDiscovery.reportError:input_type -> functions.UserFunctionError
	9,  // 18: functions.EntityDiscovery.discover:output_type -> functions.EntitySpec
	17, // 19: functions.EntityDiscovery.reportError:output_type -> google.protobuf.Empty
